...
const int16_t zetas_inv_asm[128] = {
    ...
    3152, 2742, 2907, 3224, 1779, 2458, 1251, 2486, 2774, 2899, 1103,
 ...
 *
 * Arguments:   - int16_t *poly: pointer to input/output vector of 256 elements
 *of Zq
 **************************************************/
void ntt(int16_t *poly) { ntt_fast(poly, zetas_asm); }
 ...
 *of Zq
 **************************************************/
void invntt(int16_t *poly) { invntt_fast(poly, zetas_inv_asm); }
