...
extern void __asm_negacyclic_ntt_32_m(uint32_t *des, const int32_t *table, int32_t Qprime, int32_t Q, uint16_t *src, int32_t RmodQ);
...
extern void __asm_negacyclic_intt_32_m(uint32_t *src, const int32_t *table, int32_t Qprime, int32_t Q);
extern void __asm_negacyclic_intt_central_32(uint32_t *src, const int32_t *table, int32_t Qprime, int32_t Q);


extern void __asm_negacyclic_ntt_16_light_m(uint16_t *des, const int16_t *table, int32_t QQprime, uint16_t *src);
...
#define NTT_forward_32(out, in) __asm_negacyclic_ntt_32_m(out, streamlined_CT_negacyclic_table_Q1, Q1prime, Q1, in, RmodQ1)
#define NTT_forward_16(out, in) __asm_negacyclic_ntt_16_light_m(out, streamlined_CT_negacyclic_table_Q2, Q2Q2prime, in)
...
#define NTT_inv_32(des) __asm_negacyclic_intt_32_m(des, streamlined_inv_CT_negacyclic_table_Q1, Q1prime, Q1)
