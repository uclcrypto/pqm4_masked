...
static inline void BS2POLmsg(const uint8_t bytes[SABER_KEYBYTES],
                             uint16_t data[SABER_N]);
static inline void BS2POLp(const uint8_t bytes[SABER_POLYCOMPRESSEDBYTES],
                           uint16_t data[SABER_N]);
static inline void BS2POLq(const uint8_t bytes[SABER_POLYBYTES],
                           uint16_t data[SABER_N]);
static inline void BS2POLT(const uint8_t bytes[SABER_SCALEBYTES_KEM],
                           uint16_t data[SABER_N]);
static inline void BS2POLmu(const uint8_t bytes[SABER_POLYSECRETBYTES],
                            uint16_t data[SABER_N]);
